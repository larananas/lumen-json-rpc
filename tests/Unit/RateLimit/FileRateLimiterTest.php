...
final class FileRateLimiterTest extends TestCase
{
    ...
    {
        $limiter = new FileRateLimiter(10, 60, sys_get_temp_dir() . '/nonexistent_deep_' . uniqid() . '/nested', failOpen: true);
    ...
    public function testFailClosedOnBadPath(): void
    {
        ...
        mkdir($readonlyDir . '/subdir', 0755, true);
        chmod($readonlyDir, 0555);
        $limiter = new FileRateLimiter(10, 60, $readonlyDir . '/subdir/deep', failOpen: false);
